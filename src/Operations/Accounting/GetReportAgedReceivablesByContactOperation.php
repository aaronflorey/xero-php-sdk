...
use Mochaka\XeroSDK\Responses\GetReportAgedReceivablesByContactResponse;
 ...
 * @tags Accounting
 */
class GetReportAgedReceivablesByContactOperation extends Request
{
    ...
    public function createDtoFromResponse(Response1 $response): GetReportAgedReceivablesByContactResponse
    {
        return GetReportAgedReceivablesByContactResponse::from($response->json());
    }
}
