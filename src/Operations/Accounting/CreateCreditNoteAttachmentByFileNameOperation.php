...
use Mochaka\XeroSDK\Responses\CreateCreditNoteAttachmentByFileNameResponse;
 ...
 * @tags Accounting
 */
class CreateCreditNoteAttachmentByFileNameOperation extends Request
{
    ...
    public function createDtoFromResponse(Response1 $response): CreateCreditNoteAttachmentByFileNameResponse
    {
        return CreateCreditNoteAttachmentByFileNameResponse::from($response->json());
    }
}
