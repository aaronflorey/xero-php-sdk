...
use Mochaka\XeroSDK\Responses\GetReportAgedPayablesByContactResponse;
 ...
 * @tags Accounting
 */
class GetReportAgedPayablesByContactOperation extends Request
{
    ...
    public function createDtoFromResponse(Response1 $response): GetReportAgedPayablesByContactResponse
    {
        return GetReportAgedPayablesByContactResponse::from($response->json());
    }
}
