...
use Mochaka\XeroSDK\Responses\GetRepeatingInvoiceHistoryResponse;
 ...
 * @tags Accounting
 */
class GetRepeatingInvoiceHistoryOperation extends Request
{
    ...
    public function createDtoFromResponse(Response1 $response): GetRepeatingInvoiceHistoryResponse
    {
        return GetRepeatingInvoiceHistoryResponse::from($response->json());
    }
}
