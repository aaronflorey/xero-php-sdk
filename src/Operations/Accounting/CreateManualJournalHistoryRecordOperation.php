...
use Mochaka\XeroSDK\Responses\CreateManualJournalHistoryRecordResponse;
 ...
 * @tags Accounting
 */
class CreateManualJournalHistoryRecordOperation extends Request
{
    ...
    public function createDtoFromResponse(Response1 $response): CreateManualJournalHistoryRecordResponse
    {
        return CreateManualJournalHistoryRecordResponse::from($response->json());
    }
}
